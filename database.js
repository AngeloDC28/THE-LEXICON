export const archiveData = [
  ...
  },
  {
      ...
      },
      {
        ...
        "hotspots": [
          ...
          },
          {
            "x": 60,
            "y": 40,
            "label": "Domestic Textile Overlay",
            "description": "The use of chair slipcovers as immediate; improvised dresses strips the textile of its intended domestic context; a profound exercise in Post-Colonial Critique. The fabric retains the memory of the furniture it once concealed. This act of rapid repurposing mimics the hasty packing of belongings during forced migration. The resulting silhouette is haunted by the absent object it was designed to cover."
          }
        ]
      },
      {
    ...
    "tags": {
      ...
      "theories": "Object-Oriented Ontology",
      "gender": "Womenswear",
    ...
    "notes": {
      "critique": "This runway executes a radical visualisation of nomadic survival. By requiring the models to physically dismantle a mid-century living room and wear it, Chalayan enforces a narrative of cultural displacement[cite: 2]. The spectacle forces an institutional critique[cite: 2] of the static domestic sphere and property ownership. The wearer relies on absolute bodily autonomy and transgression[cite: 2] to carry their history with them; effectively collapsing the boundary between the architectural environment and the biological body to survive global instability.",
