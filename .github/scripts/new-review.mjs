...
console.log(`  3. publishedAt is null by default — it stays that way (unpublished draft, excluded`);
console.log(`     from the /reviews/ index) until you set a real date yourself. Never inferred.`);
console.log(`  4. npm run build-reviews   # regenerates reviews.js and reviews/${slug}/`);
console.log(`  5. npm run check           # validates before commit`);
