...
async function loadArchiveData() {
  ...
  const { archiveData: staticData } = await import('../database.js?v=7a3dc55');
...
function refreshChrome() {
  ...
  const langDisplay = ALL_LANGS.find(l => l.code === lang)?.label || lang.toUpperCase();
  if (btnLangLabel) btnLangLabel.textContent = langDisplay + ' ▾';
